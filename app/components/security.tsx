    ...
    return (
        <section className="py-[41px] md:px-20 px-8 justify-center grid gap-y-[25px]">
            <div className="text-center">
                <h3 className="font-bold text-5xl">Security & Privacy Commitment</h3>
                <p className="font-light text-2xl">Your Security, Our Priority</p>
            </div>
            <Image className="mx-auto" src="/security.png" alt="security" width={388} height={250}/>
            <ul className="md:text-2xl text-lg list-disc">
