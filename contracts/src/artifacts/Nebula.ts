...
import NebulaContractArtifactJson from '../../target/nebula-Nebula.json' assert { type: 'json' };
export const NebulaContractArtifact = loadContractArtifact(NebulaContractArtifactJson as NoirCompiledContract);
...
/**
 * Type-safe interface for contract Nebula;
 */
export class NebulaContract extends ContractBase {
  
  private constructor(
    instance: ContractInstanceWithAddress,
    wallet: Wallet,
  ) {
    super(instance, NebulaContractArtifact, wallet);
  }
  ...
  public static async at(
    ...
    return Contract.at(address, NebulaContract.artifact, wallet) as Promise<NebulaContract>;
  }
  ...
  public static deploy(wallet: Wallet, admin: AztecAddressLike, name: string, symbol: string, decimals: (bigint | number)) {
    return new DeployMethod<NebulaContract>(PublicKeys.default(), wallet, NebulaContractArtifact, NebulaContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, admin: AztecAddressLike, name: string, symbol: string, decimals: (bigint | number)) {
    return new DeployMethod<NebulaContract>(publicKeys, wallet, NebulaContractArtifact, NebulaContract.at, Array.from(arguments).slice(2));
  }

  /**
   * Creates a tx to deploy a new instance of this contract using the specified constructor method.
   */
  public static deployWithOpts<M extends keyof NebulaContract['methods']>(
    opts: { publicKeys?: PublicKeys; method?: M; wallet: Wallet },
    ...args: Parameters<NebulaContract['methods'][M]>
  ) {
    return new DeployMethod<NebulaContract>(
  ...
  public static get artifactForPublic(): ContractArtifact {
    return loadContractArtifactForPublic(NebulaContractArtifactJson as NoirCompiledContract);
  }
  

  public static get storage(): ContractStorageLayout<'admin' | 'minters' | 'balances' | 'total_supply' | 'public_balances' | 'symbol' | 'name' | 'decimals' | 'user_address' | 'email_lookup' | 'is_registered'> {
      return {
        admin: {
      slot: new Fr(1n),
    },
...
is_registered: {
      ...
      } as ContractStorageLayout<'admin' | 'minters' | 'balances' | 'total_supply' | 'public_balances' | 'symbol' | 'name' | 'decimals' | 'user_address' | 'email_lookup' | 'is_registered'>;
    }
  ...
  public declare methods: {
    ...
    /** check_if_registered(user: struct) */
    check_if_registered: ((user: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** get_user_address(email_hash: field) */
    get_user_address: ((email_hash: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** get_user_email(user: struct) */
    get_user_email: ((user: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** is_minter(minter: struct) */
    is_minter: ((minter: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** mint_by_email(email_hash: field, amount: integer) */
    mint_by_email: ((email_hash: FieldLike, amount: (bigint | number)) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** mint_to_private_by_email(from: struct, email_hash: field, amount: integer) */
    mint_to_private_by_email: ((from: AztecAddressLike, email_hash: FieldLike, amount: (bigint | number)) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** register_user(email_hash: field, user: struct) */
    register_user: ((email_hash: FieldLike, user: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** register_user_public(email_hash: field, user: struct) */
    register_user_public: ((email_hash: FieldLike, user: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
